...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Perizinan Akses Jadwal", href: "/admin/jadwal/perizinan", description: "Beri akses Set Jadwal ke karyawan" },
      { label: "Peminjaman Barang", href: "/admin/item-loans", description: "Catat peminjaman barang/aset oleh karyawan" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "KPI Logistik", href: "/admin/kpi/logistik", description: "Penilaian KPI Supervisor divisi Logistik" },
    ],
  },
  {
    group: "Slip Gaji",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Set Jadwal (Grup Shift)", href: "/admin/master/set-jadwal", description: "Atur dropdown shift per grup karyawan" },
